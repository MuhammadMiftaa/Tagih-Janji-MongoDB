        ...
        <main>
          ...
          <div className="pt-16 bg-zinc-50">
            ...
            >
              ...
              >
                Tahun politik 2024 merupakan momen bagi masyarakat Indonesia
                untuk memilih presiden dan wakil presiden serta calon anggota
                legislatif yang baru. Saat ini publik tengah antusias
                menyaksikan debat calon presiden dan calon wakil presiden
                sebagai sarana mengekspos visi-misi para kandidat tersebut.
              </p>
              <Image
              ...
              <div className="z-20">
                <p className="my-3" style={{ textShadow: "1px 1px 1px #ccc" }}>
                  ...
                  pemilih pada kandidat yang sudah dipilih sebelum debat
                  berlangsung atau untuk memoderasi, bahkan mengoreksi pilihan
                  seseorang. Sementara di tingkat daerah juga bermunculan poster
                  dan baliho kandidat calon anggota legislatif beserta
                  janji-janji bombastis dan retorika manis guna menarik
                  dukungan.
                </p>
                <p className="my-3" style={{ textShadow: "1px 1px 1px #ccc" }}>
                  Meskipun debat dan penyampaian janji-janji dalam masa kampanye
                  merupakan tahapan yang penting dalam proses politik, publik
                  seakan dilanda amnesia terhadap apa yang dijanjikan para
                  pemimpin terpilih pascapemilu. Hal ini mencerminkan lemahnya
                  akuntabilitas politik pemimpin terhadap pemilihnya.
                </p>
                <p className="my-3" style={{ textShadow: "1px 1px 1px #ccc" }}>
                  Selain itu, negara ini juga tidak mengenal sistem ”kontrak
                  politik” yang mengikat pemimpin dengan konstituennya. Dalam
                  kontrak tersebut, idealnya ada perjanjian bahwa pemimpin
                  terpilih harus benar-benar mewujudkan apa yang sudah
                  dijanjikannya.
                </p>
              </div>
            </div>
            <div className="bg-yellow py-20">
              ...
              <div className="px-48 flex justify-center items-center h-[40rem] flex-col relative">
                <div className="text-neutral-900 font-lora dark:text-neutral-400 text-xl md:text-3xl max-w-3xl mx-auto">
                  ...
                  sejahtera. <br />
                  <br />
                  Kita semua memiliki peran dalam memastikan janji-janji ini
                  bukan sekadar kata-kata, tetapi menjadi kenyataan yang membawa
